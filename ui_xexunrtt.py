...
class Ui_xexun_rtt(object):
    def setupUi(self, xexun_rtt):
        ...
        self.gridLayout.addItem(self.horizontalSpacer_4, 2, 16, 1, 1)
        ...
        self.gridLayout.addItem(self.horizontalSpacer_10, 2, 6, 1, 2)
        ...
        self.gridLayout.addWidget(self.pushButton, 1, 17, 1, 1)
