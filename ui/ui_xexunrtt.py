...
class Ui_RTTMainWindow(object):
    def setupUi(self, RTTMainWindow):
        ...
        self.bottom_container.setMinimumSize(QSize(0, 70))
        ...
        sizePolicy2.setHeightForWidth(self.button_command_area.sizePolicy().hasHeightForWidth())
        self.button_command_area.setSizePolicy(sizePolicy2)
        ...
        self.reconnect_timeout_edit.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.sent.setMinimumSize(QSize(100, 20))

        self.gridLayout.addWidget(self.sent, 1, 13, 1, 2)
        ...
        self.gridLayout.addWidget(self.font_combo, 1, 10, 1, 1)
        ...
        self.gridLayout.addItem(self.horizontalSpacer, 1, 19, 1, 1)
        ...
        self.gridLayout.addWidget(self.fontsize_box, 1, 11, 1, 1)
        ...
        sizePolicy4.setHeightForWidth(self.cmd_buffer.sizePolicy().hasHeightForWidth())
        self.cmd_buffer.setSizePolicy(sizePolicy4)
        self.cmd_buffer.setFont(font)
        self.cmd_buffer.setEditable(True)

        self.gridLayout.addWidget(self.cmd_buffer, 0, 0, 1, 20)

        self.rtt_block_combo = QComboBox(self.button_command_area)
        self.rtt_block_combo.setObjectName(u"rtt_block_combo")
        sizePolicy3.setHeightForWidth(self.rtt_block_combo.sizePolicy().hasHeightForWidth())
        self.rtt_block_combo.setSizePolicy(sizePolicy3)
        self.rtt_block_combo.setMinimumSize(QSize(100, 20))
        self.rtt_block_combo.setFont(font)

        self.gridLayout.addWidget(self.rtt_block_combo, 1, 12, 1, 1)
        ...
        sizePolicy5.setHeightForWidth(self.jlink_log_area.sizePolicy().hasHeightForWidth())
        self.jlink_log_area.setSizePolicy(sizePolicy5)
        self.jlink_log_area.setMinimumSize(QSize(0, 80))
        ...
        sizePolicy6.setHeightForWidth(self.jlink_log_text.sizePolicy().hasHeightForWidth())
        self.jlink_log_text.setSizePolicy(sizePolicy6)
        font2 = QFont()
