...
class Ui_RTTMainWindow(object):
    def setupUi(self, RTTMainWindow):
        ...
        sizePolicy3.setHeightForWidth(self.cmd_buffer.sizePolicy().hasHeightForWidth())
        self.cmd_buffer.setSizePolicy(sizePolicy3)
        font = QFont()
        ...
        sizePolicy4.setHeightForWidth(self.font_combo.sizePolicy().hasHeightForWidth())
        self.font_combo.setSizePolicy(sizePolicy4)
